...
return [
	...
	'user-management' => [
		'title' => 'Menaxhimi i perdorueseve',
		'fields' => [
		],
	],
	...
	'users' => [
		...
		'fields' => [
			...
			'role' => 'Roli',
			'remember-token' => 'Mbaj ne mend TOKENIN',
		],
	],
	...
	'bookings' => [
		...
		'fields' => [
			...
			'time-from' => 'Check-in',
			'time-to' => 'Check-out',
			'additional-information' => 'Informata shtese',
		],
	],
	...
	'find-room' => [
        ...
        'no_rooms_found' => 'Nuk eshte gjetur asnje dhome per daten tuaj te zgjedhur.',
        'book_room' => 'Rezervo dhomen',
    ],

    'requests' => [
		'title' => 'Kerkesat nga WEBI',
		'fields' => [
		],
	...
	'qa_edit' => 'Ndrysho',
	'qa_restore' => 'Ktheje',
	'qa_permadel' => 'Fshije per gjithmone',
	'qa_all' => 'Te gjitha',
	'qa_trash' => 'Shporta',
	'qa_view' => 'Shfaq',
	'qa_update' => 'Perditeso',
	'qa_list' => 'List',
	'qa_no_entries_in_table' => 'Asgje ne tabele',
	'qa_custom_controller_index' => 'Custom controller index.',
	'qa_logout' => 'Dil',
	'qa_add_new' => 'Shto nje te ri',
	'qa_are_you_sure' => 'A je i sigurte?',
	'qa_back_to_list' => 'Kthehu tek lista',
	'qa_dashboard' => 'Paneli',
	'qa_delete' => 'Fshije',
	'qa_delete_selected' => 'Fshij te perzgjedhuren',
	'qa_category' => 'Kategoria',
	'qa_categories' => 'Kategorite',
	'qa_sample_category' => 'Moster kategori',
	'qa_questions' => 'Pyetjet',
	'qa_question' => 'Pyetjet',
	'qa_answer' => 'Pergjigje',
	'qa_sample_question' => 'Moster pyetje',
	'qa_sample_answer' => 'Moster pergjigje',
	'qa_faq_management' => 'FAQ Menaxhmenti',
	'qa_administrator_can_create_other_users' => 'Administratori (mund te krijoj perdorues te tjere)',
	'qa_simple_user' => 'Perdorues i thjeshte',
	'qa_title' => 'Titulli',
	'qa_roles' => 'Rolet',
	'qa_role' => 'Roli',
	'qa_user_management' => 'Menaxhimi perdoruesit',
	'qa_users' => 'Perdoruesit',
	'qa_user' => 'Perdoruesi',
	'qa_name' => 'Emri',
	'qa_email' => 'Emaili',
	'qa_password' => 'Fjalekalimi',
	'qa_remember_token' => 'Mbaj ne mend token-in',
	'qa_permissions' => 'Autorizimet',
	'qa_user_actions' => 'Veprimet e perdoruesit',
	'qa_action' => 'Veprimi',
	'qa_action_model' => 'Action model',
	'qa_action_id' => 'Veprimi id',
	'qa_time' => 'Koha',
	'qa_campaign' => 'Kampanja',
	'qa_campaigns' => 'Kampanjet',
	'qa_description' => 'Pershkrimi',
	'qa_valid_from' => 'Valid nga',
	'qa_valid_to' => 'Valid deri',
	'qa_discount_amount' => 'Cmimi zbrijtes',
	'qa_discount_percent' => 'Perqindja e zbritjes',
	'qa_coupons_amount' => 'Sasia kuponeve',
	'qa_coupons' => 'Kuponet',
	'qa_code' => 'Kodi',
	...
	'qa_current_password' => 'Fjalekalimi aktual',
	'qa_new_password' => 'Fjalekalimi i ri',
	'qa_password_confirm' => 'Konfirmimi i fjalekalimit ri',
	'qa_dashboard_text' => 'Pershendetje! Ju jeni loguar ne sistemin per menaxhim te rezervimeve.',
	'qa_forgot_password' => 'Keni harruar fjalekalimin?',
	'qa_remember_me' => 'Me mbaj mend',
	'qa_login' => 'Identifikohu',
	'qa_change_password' => 'Ndrysho fjalekalimin',
	'qa_csv' => 'CSV',
	'qa_print' => 'Print',
	'qa_excel' => 'Excel',
	'qa_copy' => 'Copy',
